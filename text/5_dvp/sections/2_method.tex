    ...
    \adjustbox{valign=b}{
        ...
        \multicolumn{2}{c}{
            \subfloat[Top down block\label{subfig:top_down}]{%
                \includegraphics[width=.26\linewidth]{pics/5_dvp/_top_down_dct_2.pdf}}
        }\\
            \subfloat[Resnet block\label{subfig:resnet}]{%
                \includegraphics[width=.22\linewidth]{pics/5_dvp/_resnet_block.pdf}} &
            \subfloat[Pseudoinput block\label{subfig:context}]{%
                \includegraphics[width=.22\linewidth]{pics/5_dvp/_context_block.pdf}} \\
    \end{tabular}}
    \end{tabular}
