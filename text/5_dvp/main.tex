...
%--------------------------------
\input{text/5_dvp/sections/0_intro}


%--------------------------------
% ==== SECTION: Background ====
%--------------------------------
\input{text/5_dvp/sections/1_background}
% \input{text/1_2_latent_space_properties_background}

%-------------------------------
% ====== SECTION: Method ======
%-------------------------------
\input{text/5_dvp/sections/2_method}

%-------------------------------
% ==== SECTION: Related ====
%-------------------------------
\input{text/5_dvp/sections/4_related}

%-------------------------------
% ==== SECTION: Experiments ====
%-------------------------------
\input{text/5_dvp/sections/3_experiments}

%------------------------------
% ====  SECTION: Conclusion ====
%------------------------------
\input{text/5_dvp/sections/5_conclusion}
