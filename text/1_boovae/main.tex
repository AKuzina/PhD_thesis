...
\begin{figure}[t]
	\centering
	\subfloat[MNIST]{\includegraphics[width=.49\textwidth]{pics/1_boovae/mnist_gen_replay.pdf}}
	\subfloat[Fashion MNIST]{	\includegraphics[width=.49\textwidth]{pics/1_boovae/fashion_mnist_gen_replay.pdf}}
	 \setfloatalignment{t} 
...
\begin{figure}[t!]
	\centering
	\subfloat{\includegraphics[width=0.5\textwidth]{pics/1_boovae/2dKL_std.pdf}} \hfill
	\subfloat{\includegraphics[width=0.5\textwidth]{pics/1_boovae/2dKL_boo20.pdf}}
	\setfloatalignment{t} 
