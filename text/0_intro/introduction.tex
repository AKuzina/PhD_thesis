...
\end{marginfigure}
\citet{salimans2016improved} proposed to use a mixture of discretized logistic distributions to improve the flexibility of the distribution. Later, it was used in deep hierarchical VAEs \citep{vahdat2020nvae, Child2020-ze}.
...
\marginnote[2\baselineskip]{We first apply definition of the KL divergence and multiply the integrand by $1$. Then using the property of the logarithm, we split the equation into two terms. }
\begin{align}
